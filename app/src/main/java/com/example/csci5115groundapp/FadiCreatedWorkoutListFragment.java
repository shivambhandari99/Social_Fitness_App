...
public class FadiCreatedWorkoutListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_fadi_created_workout_list, container, false);

        // Fadi Workout Text
        View fadiWorkout = view.findViewById(R.id.fadi_workout_view_more);
