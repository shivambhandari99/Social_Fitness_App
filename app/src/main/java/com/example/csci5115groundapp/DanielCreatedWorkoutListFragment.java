...
public class DanielCreatedWorkoutListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_daniel_created_workout_list, container, false);

        // Daniel Workout Text
        View danielWorkout = view.findViewById(R.id.daniel_workout_view_more);
