...
public class PeterOnePunchWorkoutFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // set title
        getActivity().setTitle("Peter's One Punch Workout");

        // This just creates the view
        View view = inflater.inflate(R.layout.fragment_peters_one_punch_workout, container, false);

        TextView recent_created = (TextView) view.findViewById(R.id.peter_comments_section);
        recent_created.setMovementMethod(new ScrollingMovementMethod());
        int comment_size = MainActivity.userCommentsHash.get("Peter").size();
        if (MainActivity.userCommentsHash.get("Peter").size() == 0) {
            recent_created.setText(Html.fromHtml("<b>None yet!</b>"));
        } else {
            String comment = "";
            for(int i = 0 ; i < comment_size ; i+=2) {
                comment += "<b>" + MainActivity.userCommentsHash.get("Peter").get(i) + "</b>"
                        + "<br/>" + MainActivity.userCommentsHash.get("Peter").get(i+1) + "<br/>";
            }
            recent_created.setText(Html.fromHtml(comment));
        }

        // add comment
        View addComment = view.findViewById(R.id.peter_add_comment);
        ...
        addComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                addCommentFragment.workout_name = "Peter";
                addCommentFragment.previous_fragment = new PeterOnePunchWorkoutFragment();
        ...
        // view creator
        View viewCreator = view.findViewById(R.id.peter_view_creator);
        ...
        // log workout
        View logWorkout = view.findViewById(R.id.peter_log_workout);
        ...
        logWorkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loggedEvent.add("Peter\'s One Punch Workout");
