...
public class JordynCreatedWorkoutListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_jordyn_created_workout_list, container, false);

        // Jordyn Workout Text
        View jordynWorkout = view.findViewById(R.id.jordyn_workout_view_more);
