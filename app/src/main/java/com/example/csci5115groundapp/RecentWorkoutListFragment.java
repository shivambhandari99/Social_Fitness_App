...
public class RecentWorkoutListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Recent Workouts");

        // This just creates the view
        View view = inflater.inflate(R.layout.fragment_recent_workout_list, container, false);

        // Jacobs Workout Text
        View jacobsWorkout = view.findViewById(R.id.jacobs_workout_recent);
        ...
        // Fadi Workout Text
        View fadiWorkout = view.findViewById(R.id.fadis_workout_recent);
        ...
        View jordynWorkout = view.findViewById(R.id.jordyns_workout_recent);
        ...
        View peterWorkout = view.findViewById(R.id.peters_workout_recent);
        ...
        // Daniel Workout Text
        View danielWorkout = view.findViewById(R.id.daniel_workout_recent);
