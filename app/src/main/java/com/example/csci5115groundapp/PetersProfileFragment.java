...
public class PetersProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_peters_profile, container, false);

        // Peter's Workout Text
        View peterWorkout = view.findViewById(R.id.peters_profile_created_workout);
        ...
        View jordynWorkout = view.findViewById(R.id.peters_profile_recent_workout);
        ...
        Button createdWorkoutViewMoreButton = view.findViewById(R.id.peters_profile_created_workout_view_more);
        ...
        createdWorkoutViewMoreButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // fragment_container (Current screen) and BrowseWorkoutsFragment
                // name of the class of the fragment you want to change it too.
                fragmentTransaction.replace(R.id.fragment_container, new PeterCreatedWorkoutListFragment());
        ...
        Button recentWorkoutViewMoreButton = view.findViewById(R.id.peters_profile_recent_workout_view_more);
