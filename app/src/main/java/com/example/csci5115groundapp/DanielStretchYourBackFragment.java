...
public class DanielStretchYourBackFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // set title
        getActivity().setTitle("Daniel's Stretch Your Back");

        // This just creates the view
        View view = inflater.inflate(R.layout.fragment_daniel_stretch_your_back, container, false);

        TextView recent_created = (TextView) view.findViewById(R.id.daniel_comments_section);
        recent_created.setMovementMethod(new ScrollingMovementMethod());
        int comment_size = MainActivity.userCommentsHash.get("Daniel").size();
        if (MainActivity.userCommentsHash.get("Daniel").size() == 0) {
            recent_created.setText(Html.fromHtml("<b>None yet!</b>"));
        } else {
            String comment = "";
            for(int i = 0 ; i < comment_size ; i+=2) {
                comment += "<b>" + MainActivity.userCommentsHash.get("Daniel").get(i) + "</b>"
                        + "<br/>" + MainActivity.userCommentsHash.get("Daniel").get(i+1) + "<br/>";
            }
            recent_created.setText(Html.fromHtml(comment));
        }

        // add comment
        View addComment = view.findViewById(R.id.daniel_add_comment);
        ...
        addComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                addCommentFragment.workout_name = "Daniel";
                addCommentFragment.previous_fragment = new DanielStretchYourBackFragment();
        ...
        // view creator
        View viewCreator = view.findViewById(R.id.daniel_view_creator);
        ...
        // log workout
        View logWorkout = view.findViewById(R.id.daniel_log_workout);
        ...
        logWorkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loggedEvent.add("Daniel\'s Stretch Your Back");
                loggedEvent.add("30-45 minutes; light weight; full-body");
