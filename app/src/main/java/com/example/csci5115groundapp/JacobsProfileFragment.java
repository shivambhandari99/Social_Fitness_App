...
public class JacobsProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_jacobs_profile, container, false);

        // Jacob's Workout Text
        View jacobWorkout = view.findViewById(R.id.jacobs_profile_created_workout);

        // This binds the button to change screens
        jacobWorkout.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        View peterWorkout = view.findViewById(R.id.jacobs_profile_recent_workout);
        ...
        Button createdWorkoutViewMoreButton = view.findViewById(R.id.jacobs_profile_created_workout_view_more);
        ...
        createdWorkoutViewMoreButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // fragment_container (Current screen) and BrowseWorkoutsFragment
                // name of the class of the fragment you want to change it too.
                fragmentTransaction.replace(R.id.fragment_container, new JacobCreatedWorkoutListFragment());
        ...
        Button recentWorkoutViewMoreButton = view.findViewById(R.id.jacobs_profile_recent_workout_view_more);
